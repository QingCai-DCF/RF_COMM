...
Verdict: `SOURCE_READY_REAL_PENDING`

Source/static checks confirm DHCP start/timeout/static fallback plumbing. Real UART and TCP fallback evidence remains pending.
