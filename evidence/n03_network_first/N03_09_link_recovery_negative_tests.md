...
Verdict: `PASS_OFFLINE_REAL_LINK_PENDING`

Offline reconnect and negative command paths are covered. Real cable unplug/replug and board reconnect evidence remains pending.
